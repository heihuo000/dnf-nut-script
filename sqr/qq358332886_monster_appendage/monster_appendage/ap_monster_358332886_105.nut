...
{
	appendage.sq_AddFunctionName("proc", "proc_appendage_monster_358332886_105")
	appendage.sq_AddFunctionName("onStart", "onStart_appendage_monster_358332886_105")
	appendage.sq_AddFunctionName("onEnd", "onEnd_appendage_monster_358332886_105")
	appendage.sq_AddFunctionName("onSourceKeyFrameFlag", "onSourceKeyFrameFlag_appendage_monster_358332886_105");
}

function onSourceKeyFrameFlag_appendage_monster_358332886_105(appendage, flagIndex)
{
	if (!appendage) return;
...
function proc_appendage_monster_358332886_105(appendage)
{
	if (!appendage) return;
...
function onStart_appendage_monster_358332886_105(appendage)
{
	if (!appendage) return;

}

function onEnd_appendage_monster_358332886_105(appendage)
{
	if (!appendage) return;
