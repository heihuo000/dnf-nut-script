...
{
	appendage.sq_AddFunctionName("proc", "proc_appendage_monster_358332886_112")
	appendage.sq_AddFunctionName("onStart", "onStart_appendage_monster_358332886_112")
	appendage.sq_AddFunctionName("onEnd", "onEnd_appendage_monster_358332886_112")
	appendage.sq_AddFunctionName("onSourceKeyFrameFlag", "onSourceKeyFrameFlag_appendage_monster_358332886_112")
	appendage.sq_AddFunctionName("onDamageParent", "onDamageParent_appendage_monster_358332886_112")
	appendage.sq_AddFunctionName("drawAppend", "drawAppend_appendage_monster_358332886_112")
	appendage.sq_AddFunctionName("onSetHp", "onSetHp_appendage_monster_358332886_112")
	appendage.sq_AddFunctionName("onApplyHpDamage", "onApplyHpDamage_appendage_monster_358332886_112")
}


function onSourceKeyFrameFlag_appendage_monster_358332886_112(appendage, flagIndex)
{
	if (!appendage) return;
...
function proc_appendage_monster_358332886_112(appendage)
{
	if (!appendage) return;
...
function onStart_appendage_monster_358332886_112(appendage)
{
	if (!appendage) return;
	local parentObj = appendage.getParent();//ÔðÓðÝ«ÓßßÚ
	if (!parentObj)
...
function onEnd_appendage_monster_358332886_112(appendage)
{
	if (!appendage) return;
}

function onSetHp_appendage_monster_358332886_112(appendage, hp, attacker)
{
...
function onDamageParent_appendage_monster_358332886_112(appendage, attacker, boundingBox, isStuck)
{
	if (!appendage) return;
	local parentObj = appendage.getParent();//ÔðÓðÝ«ÓßßÚ
	if (!parentObj)
