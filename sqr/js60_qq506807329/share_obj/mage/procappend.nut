...
function procAppend_po_qq506807329new_mage_24372(obj)
{
 ...
 local crystalObj = vGQtFslW8ch9RDQli3l.get_obj_vector(0);
 if(!crystalObj){
    break;
 }
 if(sq_IsEnd(crystalObj.getCurrentAnimation()))
 {
 ...
 crystalObj.setCurrentAnimation(Wf1FuRBb2qMP7tA);
 ...
 local dCO66MBFwkp = sq_GetUniformVelocity(obj.getVar().get_vector(0),
 obj.getVar().get_vector(1), b32Jwfl9lBacB, nIXBZVSj60hHF4DO7);
 ...
 local b32Jwfl9lBacB = sq_GetCurrentTime(MuSVlMOqvRSbetB7Tnk);
 local nIXBZVSj60hHF4DO7 = MuSVlMOqvRSbetB7Tnk.getDelaySum(false);
 local dCO66MBFwkp = sq_GetUniformVelocity(obj.getVar("move").get_vector(0),
 obj.getVar("move").get_vector(1), b32Jwfl9lBacB, nIXBZVSj60hHF4DO7);
 sq_setCurrentAxisPos(obj, 0, dCO66MBFwkp);
 }
 break;
 }
