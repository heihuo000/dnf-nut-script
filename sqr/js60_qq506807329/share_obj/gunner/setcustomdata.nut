...
function setCustomData_po_qq506807329new_gunner_24371(obj, receiveData) {
	...
	switch (index) {
		...
		case 232:
			...
			local
			var = obj.getVar();
			var.push_vector(receiveData.readDword());
			var.push_vector(receiveData.readDword());
		...
		case 233:
			...
			switch (lI5XAVV7Ex) {
				...
				case 2:
					...
					local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/seismicwave/loop/loop_seismicwaveground.ani");
					local pd5tcg5lVLri = 1.20833333;
					ani.setImageRateFromOriginal(pd5tcg5lVLri, pd5tcg5lVLri);
					ani.setAutoLayerWorkAnimationAddSizeRate(pd5tcg5lVLri);
					sq_SetAttackBoundingBoxSizeRate(ani, pd5tcg5lVLri, pd5tcg5lVLri, pd5tcg5lVLri);
					obj.setCurrentAnimation(ani);
		...
		case 234:
			...
			local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/plasmaboost/plasmaboostlaserloop_00.ani");
			obj.setCurrentAnimation(ani);
		...
		case 235:
			...
			switch (lI5XAVV7Ex) {
				case 1:
					local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/bursterbeamnew/bb2ndatkaeff_laser.ani");
					obj.setCurrentAnimation(ani);
					break;
				case 2:
					sq_ChangeDrawLayer(obj, ENUM_DRAWLAYER_BOTTOM);
					local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/bursterbeamnew/bb2ndfloorexpla_floordodge_a.ani");
					obj.setCurrentAnimation(ani);
					break;
				case 3:
					local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/bursterbeamnew/bb2ndfloorexplb_light_a.ani");
					obj.setCurrentAnimation(ani);
			...
			break;
		case 236:
			local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/deadlyapproach/shooteffect_1.ani");
			obj.setCurrentAnimation(ani);
		...
		case 237:
			...
			switch (lI5XAVV7Ex) {
				case 1:
					local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/wipeout/wipeoutattack01_12.ani");
					obj.setCurrentAnimation(ani);
					sq_SetCurrentAttackInfoFromCustomIndex(obj, 9);
					break;
				case 2:
					local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/wipeout/wipeoutattack02_hitf_02.ani");
					obj.setCurrentAnimation(ani);
					local BSH312D3zSZDte1xy_1Mkbo = sq_GetCustomAttackInfo(obj, 10);
					sq_SetCurrentAttackBonusRate(BSH312D3zSZDte1xy_1Mkbo, receiveData.readDword());
					sq_SetCurrentAttackInfo(obj, BSH312D3zSZDte1xy_1Mkbo);
					local v7nUkcMLFhj9rm48iy9f7J = receiveData.readDword() - 1;
					local XD3gEj67qR2eoOD9jqgICFui = ani.getDelaySum(0, 7);
					obj.setTimeEvent(0, XD3gEj67qR2eoOD9jqgICFui / v7nUkcMLFhj9rm48iy9f7J, v7nUkcMLFhj9rm48iy9f7J, false);
					break;
			}
			break;
		case 239:
			local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/fastdraw/fastdraw_bullet_normal.ani");
			obj.setCurrentAnimation(ani);
		...
		case 240:
			...
			switch (receiveData.readDword()) {
				case 1:
					H9jmFYxH3FHeXdq += "1shoot.ani";
					obj.setTimeEvent(0, 30, 1, false);
					break;
				case 2:
					H9jmFYxH3FHeXdq += "2shoot.ani";
					obj.setTimeEvent(0, 30, 1, false);
					break;
				case 3:
					H9jmFYxH3FHeXdq += "3shoot.ani";
					obj.setTimeEvent(0, 30, 1, false);
					break;
				case 4:
					H9jmFYxH3FHeXdq += "4shoot.ani";
					obj.setTimeEvent(0, 30, 1, false);
					break;
				case 5:
					H9jmFYxH3FHeXdq += "5shoot.ani";
					break;
				case 6:
					H9jmFYxH3FHeXdq += "6shoot.ani";
					break;
				case 7:
					H9jmFYxH3FHeXdq += "last.ani";
					ncqkDb0A6g = 13;
					break;
			}
			local ani = sq_CreateAnimation("", H9jmFYxH3FHeXdq);
			obj.setCurrentAnimation(ani);
			...
			break;
		case 241:
			local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/bulletpistolcarbine.ani");
			obj.setCurrentAnimation(ani);
		...
		case 242:
			...
			var.push_vector(pd5tcg5lVLri);
			var.push_vector(dGDQiVvp0n92FnxWmTL53F);
			var.push_vector(KAThx5SpHK94m8_ppXpsl7J);
			...
			switch (receiveData.readWord()) {
				...
				case 2:
					...
					break;
				case 3:
					obj.sq_SetMoveParticle("particle/grenadeup.ptl", 0.0, 0.0);
					break;
			}
			if (obj.isMyControlObject())
				obj.addSetStatePacket(10, sq_GetGlobalIntVector(), STATE_PRIORITY_AUTO, false, "");
		...
		case 243:
			...
			if (lI5XAVV7Ex == 1) {
				...
				var.push_vector(receiveData.readDword());
				var.push_vector(receiveData.readDword());
				var.push_vector(obj.getXPos());
				var.push_vector(obj.getYPos());
				if (obj.isMyControlObject())
					obj.addSetStatePacket(10, sq_GetGlobalIntVector(), STATE_PRIORITY_AUTO, false, "");
			} else if (lI5XAVV7Ex == 2) {
				local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/dangerclose/dangershell.ani");
				obj.setCurrentAnimation(ani);
		...
		case 244:
			...
			if (lI5XAVV7Ex == 1) {
				...
				local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/g-38arg/shot01.ani");
				obj.setCurrentAnimation(ani);
		...
		case 245:
			...
			if (lI5XAVV7Ex == 1) {
				...
				local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/supernova/floorloop/floorloop_floornormal.ani");
		...
		case 246:
			...
			switch (lI5XAVV7Ex) {
				...
				case 2:
					...
					break;
				case 3:
					local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/dimensionrunner/new/attackareadummy.ani");
					obj.setCurrentAnimation(ani);
		...
		case 247:
			...
			switch (lI5XAVV7Ex) {
				case 1:
					...
					var.push_vector(receiveData.readDword());
					var.push_vector(receiveData.readDword());
					var.push_vector(receiveData.readWord());
					if (obj.isMyControlObject())
						obj.addSetStatePacket(10, sq_GetGlobalIntVector(), STATE_PRIORITY_AUTO, false, "");
					break;
				case 2:
					local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/hellmarch/hellmarchdummyexplosion.ani");
					obj.setCurrentAnimation(ani);
					local BSH312D3zSZDte1xy_1Mkbo = sq_GetCustomAttackInfo(obj, 28);
					sq_SetCurrentAttackBonusRate(BSH312D3zSZDte1xy_1Mkbo, receiveData.readDword());
					sq_SetCurrentAttackInfo(obj, BSH312D3zSZDte1xy_1Mkbo);
					local OIUmvF0yo22yS3Qofy = receiveData.readDword() - 1;
					obj.setTimeEvent(5, ani.getDelaySum(false) / OIUmvF0yo22yS3Qofy, OIUmvF0yo22yS3Qofy, false);
					break;
				case 3:
					local ani = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/gunner/animation/hellmarch/hellmarchdummy.ani");
					obj.setCurrentAnimation(ani);
