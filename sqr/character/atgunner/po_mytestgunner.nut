function setCustomData_po_mytestgunner(obj, receiveData)
{
	...
	if(id == 169)
	{
		...
		{
			setCurrentAnimationFromCutomIndex(obj, 0);
			attackInfo = sq_GetCustomAttackInfo(obj, 1);//ÊÇßä£»÷åüù
		...
		else if(WeaponSubType == 2)//ÜÆóæ
		{
			...
			attackInfo = sq_GetCustomAttackInfo(obj, 4);//ÊÇßä£»÷åüù
		...
		else if(WeaponSubType == 3)//â¢?
		{
			...
			attackInfo = sq_GetCustomAttackInfo(obj, 3);//ÊÇßä£»÷åüù
		...
		else if(WeaponSubType == 4)//â¢ÒÀ
		{
			...
			attackInfo = sq_GetCustomAttackInfo(obj, 2);//ÊÇßä£»÷åüù
