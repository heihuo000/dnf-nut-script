...
function NitroMotor(obj)
{
    ...
    switch(state)
	{
		...
		case 6:
			...
			CommonEnableNitroMotor(obj, 48, STATE_SKY_CROSSSHOOT);//ß¤ï¿½ï¿½ï¿½ï¿½
			CommonEnableNitroMotor(obj, 109, STATE_SKY_CHARGEBUSTER);//ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
			CommonEnableNitroMotor(obj, 53, STATE_SKY_NAPALMBOMB);//ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿?
			CommonEnableNitroMotor(obj, 78, STATE_SKY_NIELSNIPING);//ï¿½ï¿½ï¿½ï¿½ï¿½Ì?
			CommonEnableNitroMotor(obj, 98, 13);//EMPï¿½ï¿½ï¿?
...
{	
	...
	{
		case 0:
			obj.sq_SetCurrentAnimation(CUSTOM_ANI_NITROMOTOR_SKY_THROW+1);
