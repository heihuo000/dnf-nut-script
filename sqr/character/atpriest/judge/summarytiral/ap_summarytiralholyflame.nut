...
{
	appendage.sq_AddFunctionName("proc", "proc_appendage_SummaryTiralHolyFlame")
	appendage.sq_AddFunctionName("onStart", "onStart_appendage_SummaryTiralHolyFlame")
	appendage.sq_AddFunctionName("onEnd", "onEnd_appendage_SummaryTiralHolyFlame")
	appendage.sq_AddFunctionName("drawAppend", "drawAppend_appendage_SummaryTiralHolyFlame")
}
...
function drawAppend_appendage_SummaryTiralHolyFlame(appendage, isOver, x, y, isFlip)
{
	if(!appendage) {
		return;		
	}
...
function proc_appendage_SummaryTiralHolyFlame(appendage)
{
	if(!appendage) {
		return;
	}
	...
	if (damager.IsSquirrelAppendage(append))
	{
		...
		local attackBonusRate = obj.sq_GetBonusRateWithPassive(SKILL_SUMMARYTIRAL, STATE_SUMMARYTIRAL, 0, holyFlameRate) + obj.sq_GetBonusRateWithPassive(SKILL_SUMMARYTIRAL, STATE_SUMMARYTIRAL, 1, holyFlameRate); 
...
function onStart_appendage_SummaryTiralHolyFlame(appendage)
{
	if(!appendage) {
		return;
	}
...
function onEnd_appendage_SummaryTiralHolyFlame(appendage)
{
	if (!appendage) {
		return;
	}	
