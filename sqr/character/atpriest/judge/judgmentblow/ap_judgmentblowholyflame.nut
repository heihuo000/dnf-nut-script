...
{
	appendage.sq_AddFunctionName("proc", "proc_appendage_JudgmentBlowHolyFlame")
	appendage.sq_AddFunctionName("onStart", "onStart_appendage_JudgmentBlowHolyFlame")
	appendage.sq_AddFunctionName("onEnd", "onEnd_appendage_JudgmentBlowHolyFlame")
	appendage.sq_AddFunctionName("drawAppend", "drawAppend_appendage_JudgmentBlowHolyFlame")
}
...
function drawAppend_appendage_JudgmentBlowHolyFlame(appendage, isOver, x, y, isFlip)
{
	if(!appendage) {
		return;		
	}
...
function proc_appendage_JudgmentBlowHolyFlame(appendage)
{
	if(!appendage) {
		return;
	}
	...
	if (damager.IsSquirrelAppendage(append))
	{
		...
		local attackBonusRate = obj.sq_GetBonusRateWithPassive(SKILL_JUDGMENTBLOW, STATE_JUDGMENTBLOW, 0, holyFlameRate) + obj.sq_GetBonusRateWithPassive(SKILL_JUDGMENTBLOW, STATE_JUDGMENTBLOW, 1, holyFlameRate); 
...
function onStart_appendage_JudgmentBlowHolyFlame(appendage)
{
	if(!appendage) {
		return;
	}
...
function onEnd_appendage_JudgmentBlowHolyFlame(appendage)
{
	if (!appendage) {
		return;
	}	
