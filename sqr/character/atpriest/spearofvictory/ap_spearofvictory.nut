...
{
	appendage.sq_AddFunctionName("proc", "proc_appendage_spearofvictory")
	appendage.sq_AddFunctionName("onStart", "onStart_appendage_spearofvictory")
	appendage.sq_AddFunctionName("onEnd", "onEnd_appendage_spearofvictory")
}
...
function proc_appendage_spearofvictory(appendage)
{
...
function onStart_appendage_spearofvictory(appendage)
{
	if(!appendage)
	{
		return;
...
function onEnd_appendage_spearofvictory(appendage)
{
	if(!appendage) {
		return;
	}
