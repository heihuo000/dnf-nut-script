...
function onAttackParent_appendage_huixiejingtong(appendage, realAttacker, damager, boundingBox, isStuck)
{
	...
	local huixiejingtong = sqrChr.GetSquirrelAppendage("character/thief/huixiejingtong/ap_huixiejingtong_buff.nut");
	if(huixiejingtong)
		huixiejingtong.setValid(false);
	CURRENT_BUFF_COUNT_HUI_XIE_JING_TONG+=1;
	huixiejingtong = CNSquirrelAppendage.sq_AppendAppendage(obj, obj, SKILL_HUI_XIE_JING_TONG, false, "character/thief/huixiejingtong/ap_huixiejingtong_buff.nut", false);
