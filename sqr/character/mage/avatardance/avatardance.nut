...
function checkExecutableSkill_mage_avatardance(obj)
{
 if(!obj) return false; 
 local uLSt3cZqKSLQEJvULdf = obj.sq_IsUseSkill(243); 
 if(uLSt3cZqKSLQEJvULdf) 
 {
 obj.sq_IntVectClear();
 obj.sq_IntVectPush(0); 
 obj.sq_AddSetStatePacket(243, STATE_PRIORITY_FORCE, true); 
 return true; 
 }
 return false; 
} ;
...
function checkCommandEnable_mage_avatardance(obj)
{
 if(!obj) return false; 
...
function onSetState_mage_avatardance(obj, R7o8jywnJsOk3MNCS43wiqp5, cBTJ3ZYG9D5SfWC3, gPjpFXG4MRyjPgH)
{
 if(!obj) return; 
 obj.sq_StopMove(); 
 obj.sq_ZStop(); 
 ...
 {
 case 0:
 if(!setCurrentAnimation_mage_avatar(obj, "AvatarDance_A.ani")) 
 ...
 break;
 case 1:
 if(!setCurrentAnimation_mage_avatar(obj, "AvatarDance_B.ani")) 
 obj.sq_SetCurrentAnimation(85);
 obj.sq_SetCurrentAttackInfo(39);
 local m88VZQY7R3KS4yh = obj.sq_GetBonusRateWithPassive(243, 243, 0, 1.0); 
 obj.sq_SetCurrentAttackBonusRate(m88VZQY7R3KS4yh); 
 break;
 case 2:
 if(!setCurrentAnimation_mage_avatar(obj, "AvatarDance_C.ani")) 
 obj.sq_SetCurrentAnimation(86);
 obj.sq_SetCurrentAttackInfo(40);
 local m88VZQY7R3KS4yh = obj.sq_GetBonusRateWithPassive(243, 243, 1, 1.0); 
 obj.sq_SetCurrentAttackBonusRate(m88VZQY7R3KS4yh); 
 break;
 case 3:
 if(!setCurrentAnimation_mage_avatar(obj, "AvatarDance_D.ani")) 
 obj.sq_SetCurrentAnimation(87);
 obj.sq_SetCurrentAttackInfo(41);
 local m88VZQY7R3KS4yh = obj.sq_GetBonusRateWithPassive(243, 243, 2, 1.0); 
 obj.sq_SetCurrentAttackBonusRate(m88VZQY7R3KS4yh); 
 break;
 case 4:
 if(!setCurrentAnimation_mage_avatar(obj, "AvatarDance_E01.ani")) 
 obj.sq_SetCurrentAnimation(88);
 break;
 case 5:
 if(!setCurrentAnimation_mage_avatar(obj, "AvatarDance_E02.ani")) 
 obj.sq_SetCurrentAnimation(89);
 obj.sq_SetCurrentAttackInfo(42);
 local m88VZQY7R3KS4yh = obj.sq_GetBonusRateWithPassive(243, 243, 3, 1.0); 
 obj.sq_SetCurrentAttackBonusRate(m88VZQY7R3KS4yh); 
 sq_SetMyShake(obj, 5, 120); 
 local H4PkhKopZyQIc8Cy9RK = obj.getVar(); 
 H4PkhKopZyQIc8Cy9RK.push_vector(obj.getXPos()); 
 ...
 H4PkhKopZyQIc8Cy9RK.push_vector(1); 
 H4PkhKopZyQIc8Cy9RK.push_vector(obj.getZPos()); 
 H4PkhKopZyQIc8Cy9RK.push_vector(obj.getZPos() + 140); 
 break;
 case 6:
 if(!setCurrentAnimation_mage_avatar(obj, "AvatarDance_F01.ani")) 
 obj.sq_SetCurrentAnimation(90);
 break;
 case 7:
 if(!setCurrentAnimation_mage_avatar(obj, "AvatarDance_F02.ani")) 
 obj.sq_SetCurrentAnimation(91);
 obj.sq_SetCurrentAttackInfo(43);
 local m88VZQY7R3KS4yh = obj.sq_GetBonusRateWithPassive(243, 243, 4, 1.0); 
 obj.sq_SetCurrentAttackBonusRate(m88VZQY7R3KS4yh); 
 sq_SetMyShake(obj, 8, 400); 
 if(obj.sq_IsMyControlObject())
 sq_flashScreen(obj, 0, 0, 180, 102, sq_RGB(255, 255, 255), GRAPHICEFFECT_LINEARDODGE, ENUM_DRAWLAYER_BOTTOM); 
 local H4PkhKopZyQIc8Cy9RK = obj.getVar(); 
 H4PkhKopZyQIc8Cy9RK.push_vector(obj.getXPos()); 
 H4PkhKopZyQIc8Cy9RK.push_vector(-1); 
 H4PkhKopZyQIc8Cy9RK.push_vector(-1); 
