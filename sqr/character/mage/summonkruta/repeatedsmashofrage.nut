...
function checkExecutableSkill_mage_repeatedsmashofrage(obj)
{
 if(!obj) return false; 
 
 local JfAVmDQT6hr3FugARMY4buv = getMyMonsterObject_Character_jsqq506807329(obj, 50680731, "character/mage/summonkruta/ap_summonkruta.nut");
 ...
 local G10KcdnKSJVXJZfV = obj.sq_IsUseSkill(137); 
 	if(G10KcdnKSJVXJZfV) 
 	{
 		obj.sq_IntVectClear();
 		obj.sq_IntVectPush(0); 
 		obj.sq_IntVectPush(sq_GetGroup(JfAVmDQT6hr3FugARMY4buv)); 
 		obj.sq_IntVectPush(sq_GetUniqueId(JfAVmDQT6hr3FugARMY4buv)); 
 		obj.sq_AddSetStatePacket(137, STATE_PRIORITY_USER, true); 
 		return true; 
 	}
 }
