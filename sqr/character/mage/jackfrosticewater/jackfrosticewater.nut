...
function onSetState_mage_jackfrosticewater(obj, QQFTyZzfnqNnrzIi8, bCXxHiJVd1ZSkBIm3MAe7Jt, VeYJxb00PjxvW1)
{
 if(!obj) return; 
 local QGpvkxGA0LThPnVSEUQmW = obj.sq_GetVectorData(bCXxHiJVd1ZSkBIm3MAe7Jt, 0); 
 ...
 local qlJ1Z20zwN2rthHpGJ7 = sq_GetSkillLevel(obj, 132); 
 local OMJ7ilFULJ1z9ZGKU = sq_GetLevelData(obj, 132, 1, qlJ1Z20zwN2rthHpGJ7); 
 local USPnIIfcabBpZSk8 = sq_GetLevelData(obj, 132, 2, qlJ1Z20zwN2rthHpGJ7); 
 ...
 obj.sq_WriteDword(sq_GetLevelData(obj, 132, 0, qlJ1Z20zwN2rthHpGJ7)); 
 ...
 case 1:
	if(skill&&!skill.isSealFunction()){
		...
		local uyAmNi10XDtMYecgBsAFj = obj.sq_GetVectorData(bCXxHiJVd1ZSkBIm3MAe7Jt, 1); 
		local BMUzn3gZSxNNo0E2gUn4zJPT = obj.sq_GetVectorData(bCXxHiJVd1ZSkBIm3MAe7Jt, 2); 
		sq_setCurrentAxisPos(obj, 0, uyAmNi10XDtMYecgBsAFj); 
		sq_setCurrentAxisPos(obj, 1, BMUzn3gZSxNNo0E2gUn4zJPT); 
