...
function checkCommandEnable_atmage_armageddonstrike(obj) {
	if(!obj) return false;
	if(sq_GetSkillLevel(obj, 199) > 0){
		return true;
	}
...
function onSetState_atmage_armageddonstrike(B74PVUwp1h, Wp5xWEER1lYn77EGo1qZc1yH, Pu4_oeBhaVMEmOM5, BmumNWaLZiLblx4u3Vd)
{
 ...
 local Xj5EUe4NUP = B74PVUwp1h.getObjectManager(); 
 local eUM8JDikchFpqPYp0wbRUE = CreateAniRate(B74PVUwp1h, "character/mage/effect/animation/atarmageddonstrike/p3/asphase3cloud_cloud_a.ani", ENUM_DRAWLAYER_COVER, Xj5EUe4NUP.getFieldXPos(400+CFG_SCREEN_WIDTH_OFFSETX, ENUM_DRAWLAYER_NORMAL), Xj5EUe4NUP.getFieldYPos(600, 0, ENUM_DRAWLAYER_NORMAL), B74PVUwp1h.getZPos(), false, B74PVUwp1h.getVar("speedRate").getFloat(0) * 100.0); 
...
function onKeyFrameFlag_atmage_armageddonstrike(ulpO7loMZ5f8mxrT, hRuY8re0Cr)
{
 ...
 ulpO7loMZ5f8mxrT.sq_SendCreatePassiveObjectPacket(24379, 0, 0, 0, 350);
 }
 break;
 case 4:
 
 local vAw11S_w7iMNnY384qt9bnGq = onGetMyPassiveObject_My(ulpO7loMZ5f8mxrT, 24379, 245, 1); 
 ...
 local SGSabkZV0NU6d4XivIKaZhBC = CreateAniRate(ulpO7loMZ5f8mxrT, "character/mage/effect/animation/atarmageddonstrike/p1/addasatkeff2_01.ani", ENUM_DRAWLAYER_COVER, D7yWSG8JPyUe.getFieldXPos(400+CFG_SCREEN_WIDTH_OFFSETX, ENUM_DRAWLAYER_NORMAL), ulpO7loMZ5f8mxrT.getYPos(), D7yWSG8JPyUe.getFieldZPos(400, ulpO7loMZ5f8mxrT.getYPos(), ENUM_DRAWLAYER_NORMAL), false, 130.0); 
