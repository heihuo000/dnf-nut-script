...
function onSetState_atmage_judekatheeternal(B74PVUwp1h, Wp5xWEER1lYn77EGo1qZc1yH, Pu4_oeBhaVMEmOM5, BmumNWaLZiLblx4u3Vd)
{
 ...
 CreateAniRate(B74PVUwp1h, "character/mage/effect/animation/atoverfreezeextension/atoverfreezeextension_bgsnow.ani", ENUM_DRAWLAYER_COVER, fKXf1kmu1lyBh9i2vT.getFieldXPos((B74PVUwp1h.getDirection() == ENUM_DIRECTION_RIGHT) ? 0 : (800+2*CFG_SCREEN_WIDTH_OFFSETX), ENUM_DRAWLAYER_NORMAL), B74PVUwp1h.getYPos(), fKXf1kmu1lyBh9i2vT.getFieldZPos(0, B74PVUwp1h.getYPos(), ENUM_DRAWLAYER_NORMAL), false, B74PVUwp1h.getVar("speedRate").getFloat(0) * 100.0); 
 }
 break;
 case 1:
 ...
 B74PVUwp1h.sq_SendCreatePassiveObjectPacket(24379, 0, 0, 0, 75);
 }
 break;
 }
} ;
