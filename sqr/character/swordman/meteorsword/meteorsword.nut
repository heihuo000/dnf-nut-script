...
function getScrollBasisPos_swordman_meteorsword(obj)
{
 if(!obj) return false;
 if(!obj.sq_IsMyControlObject()) return false;
 local Xd3gv_DWrtDdETDoItdqSZVr = obj.getSkillSubState(); 
 if(Xd3gv_DWrtDdETDoItdqSZVr == 4)
 {
 local PHn9LyQF4U6fi = obj.getVar("state"); 
 local L7A33BrlpB0jFkGy_j = PHn9LyQF4U6fi.get_vector(0); 
 switch(L7A33BrlpB0jFkGy_j)
 {
 case 3:
 local oJwtldMwmnMUChYv30JLi0 = obj.sq_GetCurrentAni(); 
 local QE8ll9_HIYb7P = sq_GetCurrentTime(oJwtldMwmnMUChYv30JLi0); 
 local XoO4SYCsu508CAt9mm9 = 300; 
 local PRaCb2QPi0giVKqP8Gv = sq_GetUniformVelocity(obj.getXPos(),
 PHn9LyQF4U6fi.get_vector(1), QE8ll9_HIYb7P, XoO4SYCsu508CAt9mm9); 
 local j9s2kayyWn6NN7M = sq_GetUniformVelocity(obj.getYPos(),
 PHn9LyQF4U6fi.get_vector(2), QE8ll9_HIYb7P, XoO4SYCsu508CAt9mm9); 
 obj.sq_SetCameraScrollPosition(PRaCb2QPi0giVKqP8Gv, j9s2kayyWn6NN7M, 0); 
 if(QE8ll9_HIYb7P >= XoO4SYCsu508CAt9mm9 / 2) 
 {
 obj.getVar("createInfo").clear_vector(); 
 local MGnP4e4uOPe3m = obj.getVar("createInfo"); 
 local skill_level = sq_GetSkillLevel(obj, 235); 
 MGnP4e4uOPe3m.push_vector(
 obj.sq_GetBonusRateWithPassive(
 235,
 235, 5, 1.0 + obj.getVar().get_vector(1) / 100.0)
 ); 
 MGnP4e4uOPe3m.push_vector(sq_GetLevelData(obj, 235, 8, skill_level)); 
 MGnP4e4uOPe3m.push_vector(sq_GetLevelData(obj, 235, 9, skill_level)); 
 
 MGnP4e4uOPe3m.push_vector(sq_GetLevelData(obj, 235, 11, skill_level)); 
 MGnP4e4uOPe3m.push_vector(sq_GetLevelData(obj, 235, 12, skill_level)); 
 MGnP4e4uOPe3m.push_vector(sq_GetLevelData(obj, 235, 13, skill_level)); 
 MGnP4e4uOPe3m.push_vector(obj.sq_GetPowerWithPassive(235, -1, 14, -1, 1.0)); 
 obj.setTimeEvent(0,
 sq_GetLevelData(obj, 235, 7, skill_level),
 sq_GetLevelData(obj, 235, 6, skill_level), true); 
 RemoveAllAni(obj); 
 ...
 if(CNSquirrelAppendage.sq_IsAppendAppendage(obj, "character/swordman/meteorsword/ap_meteorsword_stateoflimit.nut"))
 CNSquirrelAppendage.sq_RemoveAppendage(obj, "character/swordman/meteorsword/ap_meteorsword_stateoflimit.nut");
 CNSquirrelAppendage.sq_AppendAppendage(obj, obj, 248, true, "character/swordman/meteorsword/ap_meteorsword_stateoflimit.nut", true); 
 }
 }
 return true;
 case 4:
 ...
 {
 PHn9LyQF4U6fi.set_vector(5, sq_GetCurrentTime(obj.sq_GetCurrentAni())); 
 PHn9LyQF4U6fi.set_vector(0, 5); 
 }
 return true;
 case 5:
 local XoO4SYCsu508CAt9mm9 = 300; 
 local QE8ll9_HIYb7P = sq_GetCurrentTime(obj.sq_GetCurrentAni()) - PHn9LyQF4U6fi.get_vector(5) + XoO4SYCsu508CAt9mm9 / 2; 
 local PRaCb2QPi0giVKqP8Gv = sq_GetUniformVelocity(obj.getXPos(),
 PHn9LyQF4U6fi.get_vector(1), QE8ll9_HIYb7P, XoO4SYCsu508CAt9mm9); 
 local j9s2kayyWn6NN7M = sq_GetUniformVelocity(obj.getYPos(),
 PHn9LyQF4U6fi.get_vector(2), QE8ll9_HIYb7P, XoO4SYCsu508CAt9mm9); 
 ...
 sq_SendChangeSkillEffectPacket(obj, 235); 
 }
 return true;
 case 6:
 case 7:
 obj.sq_SetCameraScrollPosition(PHn9LyQF4U6fi.get_vector(1), PHn9LyQF4U6fi.get_vector(2), 0); 
 return true;
 }
 }
 return false;
