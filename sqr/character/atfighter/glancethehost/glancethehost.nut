...
function onSetState_atfighter_glancethehost(obj, aT_BxRH3rlPMrHLlXVwx, A_iSCdC3ETVcvIVRKi21u, LNBfBO9gwSWVcTOeQiC0WHGz)
{
 if(!obj) return; 
 obj.sq_StopMove(); 
 local uBH2T8zbA9aHbhrXtlqX = obj.sq_GetVectorData(A_iSCdC3ETVcvIVRKi21u, 0); 
 obj.setSkillSubState(uBH2T8zbA9aHbhrXtlqX); 
 ...
 local piCYIS7yd1qzUJDssb = sq_CreateDrawOnlyObject(obj, "character/fighter/effect/animation/atglancethehost/cast/ghcasteffect_casting03.ani", ENUM_DRAWLAYER_NORMAL, true);
 sq_moveWithParent(obj, piCYIS7yd1qzUJDssb); 
 obj.getVar().push_obj_vector(piCYIS7yd1qzUJDssb);
 break;
 case 1:
 obj.sq_SetCurrentAnimation(151);
 
 local piCYIS7yd1qzUJDssb = sq_CreateDrawOnlyObject(obj, "character/fighter/effect/animation/atglancethehost/start/ghstartground_normal.ani", ENUM_DRAWLAYER_BOTTOM, true);
 
 local xdif8qdKmlmZCnFwjFbiTZj8 = sq_CreateDrawOnlyObject(obj, "character/fighter/effect/animation/atglancethehost/start/ghstarteffect_circle01.ani", ENUM_DRAWLAYER_NORMAL, true);
 
 local OnXmC6kNQyD8gfr1epynxl4D = sq_CreateDrawOnlyObject(obj, "character/fighter/effect/animation/atglancethehost/start/ghstartdustf_01.ani" ENUM_DRAWLAYER_NORMAL, true);
 
 local WLf6pcV8gzRloYs8Csp121ja = sq_CreateDrawOnlyObject(obj, "character/fighter/effect/animation/atglancethehost/start/ghstartdustb_dustb01.ani", ENUM_DRAWLAYER_BOTTOM, true);
 sq_moveWithParent(obj, piCYIS7yd1qzUJDssb); 
 sq_moveWithParent(obj, xdif8qdKmlmZCnFwjFbiTZj8); 
 sq_moveWithParent(obj, OnXmC6kNQyD8gfr1epynxl4D); 
 sq_moveWithParent(obj, WLf6pcV8gzRloYs8Csp121ja); 
 obj.getVar().push_obj_vector(piCYIS7yd1qzUJDssb);
 obj.getVar().push_obj_vector(xdif8qdKmlmZCnFwjFbiTZj8);
 obj.getVar().push_obj_vector(OnXmC6kNQyD8gfr1epynxl4D);
 obj.getVar().push_obj_vector(WLf6pcV8gzRloYs8Csp121ja);
 if(obj.sq_IsMyControlObject())
 sq_flashScreen(obj, 0, 120, 0, 255, sq_RGB(0, 0, 0), GRAPHICEFFECT_NONE, ENUM_DRAWLAYER_CLOSEBACK); 
 obj.sq_PlaySound("MF_GLANCEHOST"); 
 break;
 case 2:
 obj.sq_SetCurrentAnimation(152);
 obj.sq_SetCurrentAttackInfo(88);
 local bmqQcrz6Rgy4K = obj.sq_GetBonusRateWithPassive(222, aT_BxRH3rlPMrHLlXVwx, 0, 1.0); 
 obj.sq_SetCurrentAttackBonusRate(bmqQcrz6Rgy4K); 
 
 local piCYIS7yd1qzUJDssb = sq_CreateDrawOnlyObject(obj, "character/fighter/effect/animation/atglancethehost/start/ghstartstone_a12.ani", ENUM_DRAWLAYER_NORMAL, true);
 
 local xdif8qdKmlmZCnFwjFbiTZj8 = sq_CreateDrawOnlyObject(obj, "passiveobject/script_sqr_nut_qq506807329/atfighter/animation/atglancethehost/ghgatheringeffect_lightning05.ani", ENUM_DRAWLAYER_NORMAL, true);
 
 local OnXmC6kNQyD8gfr1epynxl4D = sq_CreateDrawOnlyObject(obj, "passiveobject/script_sqr_nut_qq506807329/atfighter/animation/atglancethehost/ghgatheringground_normal.ani", ENUM_DRAWLAYER_BOTTOM, true);
 
 local WLf6pcV8gzRloYs8Csp121ja = sq_AddDrawOnlyAniFromParent(obj, "passiveobject/script_sqr_nut_qq506807329/atfighter/animation/atglancethehost/ghgatheringstoneb_e04.ani", 0, -1, 0);
 
 local RKxCp9p0vgB9 = sq_CreateDrawOnlyObject(obj, "passiveobject/script_sqr_nut_qq506807329/atfighter/animation/atglancethehost/ghgatheringstonef_d02.ani", ENUM_DRAWLAYER_NORMAL, true);
 sq_moveWithParent(obj, xdif8qdKmlmZCnFwjFbiTZj8); 
 sq_moveWithParent(obj, piCYIS7yd1qzUJDssb); 
 sq_moveWithParent(obj, OnXmC6kNQyD8gfr1epynxl4D); 
 sq_moveWithParent(obj, WLf6pcV8gzRloYs8Csp121ja); 
 sq_moveWithParent(obj, RKxCp9p0vgB9); 
 obj.getVar("aniobj").push_obj_vector(xdif8qdKmlmZCnFwjFbiTZj8); 
 obj.getVar("aniobj").push_obj_vector(piCYIS7yd1qzUJDssb);
 obj.getVar("aniobj").push_obj_vector(OnXmC6kNQyD8gfr1epynxl4D);
 obj.getVar("aniobj").push_obj_vector(WLf6pcV8gzRloYs8Csp121ja);
 obj.getVar("aniobj").push_obj_vector(RKxCp9p0vgB9);
 obj.getVar("aniobj").setObject(0, xdif8qdKmlmZCnFwjFbiTZj8); 
 ...
 local q0U0c5Qb6Lr4Vha8vV = obj.getVar().get_timer_vector(0);
 ...
 obj.getVar().push_vector(220); 
 obj.getVar().push_vector(qBdo21TS8WXXozpc); 
 obj.getVar().push_vector(qBdo21TS8WXXozpc*2); 
 break;
 case 3:
 obj.sq_SetCurrentAnimation(153);
 obj.sq_SetCurrentAttackInfo(89);
 local bmqQcrz6Rgy4K = obj.sq_GetBonusRateWithPassive(222, aT_BxRH3rlPMrHLlXVwx, 1, 1.0); 
 obj.sq_SetCurrentAttackBonusRate(bmqQcrz6Rgy4K); 
 
 local piCYIS7yd1qzUJDssb = sq_CreateDrawOnlyObject(obj, "character/fighter/effect/animation/atglancethehost/end/ghendstone_d05.ani", ENUM_DRAWLAYER_NORMAL, true);
 
 local xdif8qdKmlmZCnFwjFbiTZj8 = sq_CreateDrawOnlyObject(obj, "character/fighter/effect/animation/atglancethehost/end/ghendground_normal.ani", ENUM_DRAWLAYER_BOTTOM, true);
 
 local OnXmC6kNQyD8gfr1epynxl4D = sq_CreateDrawOnlyObject(obj, "character/fighter/effect/animation/atglancethehost/end/ghendexplosion_circle01.ani", ENUM_DRAWLAYER_NORMAL, true);
 sq_moveWithParent(obj, piCYIS7yd1qzUJDssb); 
 sq_moveWithParent(obj, xdif8qdKmlmZCnFwjFbiTZj8); 
 sq_moveWithParent(obj, OnXmC6kNQyD8gfr1epynxl4D); 
 obj.getVar().push_obj_vector(piCYIS7yd1qzUJDssb);
 obj.getVar().push_obj_vector(xdif8qdKmlmZCnFwjFbiTZj8);
 obj.getVar().push_obj_vector(OnXmC6kNQyD8gfr1epynxl4D);
 obj.sq_PlaySound("MF_GLANCEHOST_EXP"); 
 break;
 }
} ;
