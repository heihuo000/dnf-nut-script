...
function onSetState_atfighter_moonlighttheearth(obj, Gf3CehPfZwSnBxuqI7qdg, jvl9UXckHEJQmMqiga6785Ki, qgEHf4cgG3bz2AJLk)
{
 if(!obj) return; 
 local iOfVo0jPKyuJrUq = obj.sq_GetVectorData(jvl9UXckHEJQmMqiga6785Ki, 0); 
 obj.setSkillSubState(iOfVo0jPKyuJrUq); 
 ...
 local OcXEknaeSVRGsQuyIPO = obj.sq_GetBonusRateWithPassive(221, Gf3CehPfZwSnBxuqI7qdg, 2, 1.0); 
 obj.sq_SetCurrentAttackBonusRate(OcXEknaeSVRGsQuyIPO); 
 local i56WhTry7MJLoh5sMH = sq_GetSkillLevel(obj, 221); 
 local YgwqdgRfu_18cNEcmhorGa5 = obj.sq_GetLevelData(221, 0, i56WhTry7MJLoh5sMH); 
 local H5ScBcVuKG7 = obj.sq_GetLevelData(221, 1, i56WhTry7MJLoh5sMH); 
 obj.getVar().clear_timer_vector();
 obj.getVar().push_timer_vector();
 local NVArDuNu6KsX = obj.getVar().get_timer_vector(0);
