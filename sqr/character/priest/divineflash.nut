...
function ChangQing_751675335_DivineFlash(obj, state, datas, isResetTimer)
{
	if(!obj) return;
	...
	if(SQRch)
	{
		...
		local Path1 = "passiveobject/chang_qing_skill/priest/animation/divineflash/DivineFlash_SingleB_Beam.ani";
		createAnimationImageRatePooledObject(obj, Path1, true, DefaultC/100.0, DefaultC/100.0, X, Y, 0);
		local Path2 = "passiveobject/chang_qing_skill/priest/animation/divineflash/DivineFlash_SingleA_Whirl.ani";
