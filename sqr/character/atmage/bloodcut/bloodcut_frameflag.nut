function onKeyFrameFlagEtc_po_bloodcut(obj, flagIndex)
{
    ...
    if (id == 105)
    {
		...
		if(isEventHorizen >0 && etcID < 4){
			local power = obj.getVar("state").get_vector(2);
			etcID = etcID + 1;
			...
			sq_BinaryWriteDword(etcID);
			sq_BinaryWriteDword(1);
			sq_SendCreatePassiveObjectPacketPos(obj, 24357, 0, PosX, PosY + 1, PosZ);
		}
    	}
        return true;
    }
