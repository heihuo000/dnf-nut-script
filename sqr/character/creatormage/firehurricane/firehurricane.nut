...
function checkCommandEnable_FireHurricane(obj)
{
	...
	{
		return obj.sq_IsCommandEnable(SKILL_FIREHURRICANE); // �����忡���� Ư����ų�� ĵ���� �����մϴ�. �۾���:������ [2012.04.20] obj.sq_IsCommandEnable(SKILL_BROKENARROW);
	}
...
function onSetState_FireHurricane(obj,state,datas,isResetTimer)
{
	...
	if (substate == SUB_STATE_FIREHURRICANE_0)
	{
		...
		local multiHitTerm = obj.sq_GetIntData(SKILL_FIREHURRICANE, 0); // 0.�ٴ���Ʈ ����
...
function onEnterFrame_FireHurricane(obj, frameIndex)
{
	...
	{
		local skill_level = obj.sq_GetSkillLevel(SKILL_FIREHURRICANE);
		local attackTotalTime = obj.sq_GetLevelData(SKILL_FIREHURRICANE, SKL_LV_1, skill_level); // 1.���ӽð�
