...
function checkCommandEnable_IceShield(obj)
{
	...
	{
		return obj.sq_IsCommandEnable(SKILL_ICESHIELD); // �����忡���� Ư����ų�� ĵ���� �����մϴ�. �۾���:������ [2012.04.20] obj.sq_IsCommandEnable(SKILL_BROKENARROW);
	}
...
function onSetState_IceShield(obj,state,datas,isResetTimer)
{
	...
	if (substate == SUB_STATE_ICESHIELD_0)
	{
		...
		local multiHitTerm = obj.sq_GetIntData(SKILL_ICESHIELD, 0); // 0.�ٴ���Ʈ ����
