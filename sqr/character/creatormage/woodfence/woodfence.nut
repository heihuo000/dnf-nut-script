...
function checkExecutableSkill_WoodFence(obj)
{
	...
	{
		obj.sq_IntVectClear();
		obj.sq_IntVectPush(SUB_STATE_WOODFENCE_0); // substate����
...
function checkCommandEnable_WoodFence(obj)
{
	...
	{
		return obj.sq_IsCommandEnable(SKILL_WOODFENCE); // �����忡���� Ư����ų�� ĵ���� �����մϴ�. �۾���:������ [2012.04.20] obj.sq_IsCommandEnable(SKILL_BROKENARROW);
	}
...
function onSetState_WoodFence(obj,state,datas,isResetTimer)
{
	...
	if (substate == SUB_STATE_FIREWALL_0)
	{
		...
		local skill_level = obj.sq_GetSkillLevel(SKILL_WOODFENCE);
		local objectNum = obj.sq_GetLevelData(SKILL_WOODFENCE, SKL_LV_0, skill_level); // 0.�����Ǵ� ������Ʈ ����
...
function onMouseMoveCharacter_WoodFence(obj, x, y)
{
	...
	local term = obj.sq_GetIntData(SKILL_WOODFENCE, 0); // ���� ����
	...
	{	
		...
		{
			local skill_level = obj.sq_GetSkillLevel(SKILL_WOODFENCE);
			local time = obj.sq_GetLevelData(SKILL_WOODFENCE, SKL_LV_1, skill_level); // 1.������Ʈ ���ӽð�
			
			sq_BinaryStartWrite();
			sq_BinaryWriteDword(time); // 1.������Ʈ ���ӽð�
