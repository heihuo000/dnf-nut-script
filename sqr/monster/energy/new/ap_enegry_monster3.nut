...
{
	appendage.sq_AddFunctionName("proc", "proc_appendage_NewStyleEnergyMonster3")
	appendage.sq_AddFunctionName("onStart", "onStart_appendage_NewStyleEnergyMonster3")
	appendage.sq_AddFunctionName("onEnd", "onEnd_appendage_NewStyleEnergyMonster3")
}
...
function onEnd_appendage_NewStyleEnergyMonster3(appendage)
{
...
function proc_appendage_NewStyleEnergyMonster3(appendage)
{
	if(!appendage) {
		return;		
	}
    ...
    {  
      ...
      if (appendage.getVar("castingObj").get_obj_vector_size() <= 0)
      {
          ...
          local front = sq_AddDrawOnlyAniFromParent(parentObj,  "common/monster/new/energy/energy_front3.ani",0,-1,0);
...
function onStart_appendage_NewStyleEnergyMonster3(appendage)
{
	if(!appendage) {
		return;
	}
