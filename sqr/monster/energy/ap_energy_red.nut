...
{
	appendage.sq_AddFunctionName("proc", "proc_appendage_NewStyleEnergyRed")
	appendage.sq_AddFunctionName("onStart", "onStart_appendage_NewStyleEnergyRed")
	appendage.sq_AddFunctionName("onEnd", "onEnd_appendage_NewStyleEnergyRed")
}
...
function onEnd_appendage_NewStyleEnergyRed(appendage)
{
    ...
    if (apd)
    {
        apd.getVar("monsterRedEnergyDrawUI").set_vector(0,-1);
        apd.getVar("monsterRedEnergyDrawUI").set_vector(1,-1);
        apd.getVar("monsterRedEnergyDrawUI").set_vector(2,-1);
        apd.getVar("monsterRedEnergyDrawUI").set_vector(3,-1);
    }

}

function proc_appendage_NewStyleEnergyRed(appendage)
{
	if(!appendage) {
		return;		
	}
    ...
    if (pChr)
    {
        pChr = sq_GetCNRDObjectToSQRCharacter(pChr);
        local apd = getComboUiAppendage(pChr);
        apd.getVar("monsterRedEnergyDrawUI").set_vector(0,monsterIconID);
        apd.getVar("monsterRedEnergyDrawUI").set_vector(1,atkID);
        apd.getVar("monsterRedEnergyDrawUI").set_vector(2,time);
        apd.getVar("monsterRedEnergyDrawUI").set_vector(3,currentT);
    }
...
function onStart_appendage_NewStyleEnergyRed(appendage)
{
	if(!appendage) {
		return;
	}
