...
{
	appendage.sq_AddFunctionName("proc", "proc_appendage_MoveMonsterEffectWithTime")
	appendage.sq_AddFunctionName("onStart", "onStart_appendage_MoveMonsterEffectWithTime")
...
function proc_appendage_MoveMonsterEffectWithTime(appendage)
{
	if(!appendage) {
		return;		
	}
...
function onStart_appendage_MoveMonsterEffectWithTime(appendage)
{
	if(!appendage) {
		return;
	}
